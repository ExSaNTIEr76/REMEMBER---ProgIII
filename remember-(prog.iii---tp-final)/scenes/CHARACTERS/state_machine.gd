@icon("res://addons/proyect_icons/state_machine_proyect_icon.png")
...
func change_to( new_state: String ) -> void:
	if controlled_node.has_method( "is_state_unlocked" ):
		if not controlled_node.is_state_unlocked( new_state ):
			#prints( "⛔ Estado bloqueado:", new_state, "en", controlled_node.name )
			return
